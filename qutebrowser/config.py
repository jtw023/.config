...
# Statusbar Font
c.fonts.statusbar = '16pt FantasqueSansMono'

# Tabs Font
c.fonts.tabs.selected = '16pt FantasqueSansMono'
c.fonts.tabs.unselected = '16pt FantasqueSansMono'

# Download Font
c.fonts.downloads = '16pt FantasqueSansMono'

# Context Menu Font
c.fonts.contextmenu = '16pt FantasqueSansMono'

# Completion Menu Font
c.fonts.completion.entry = '16pt FantasqueSansMono'
c.fonts.completion.category = '16pt FantasqueSansMono'

# Keybindings Font
c.fonts.hints = '16pt FantasqueSansMono'
c.fonts.keyhint = '16pt FantasqueSansMono'

# Prompts Font
c.fonts.prompts = '16pt FantasqueSansMono'
...
config.bind('sd', 'hint links spawn alacritty -e youtube-dl -x --audio-format mp3 --audio-quality 320k -o "%(title)s.%(ext)s" {hint-url}')
...
c.url.start_pages = 'https://searx.ir/'

c.url.searchengines = {
        'DEFAULT': 'https://searx.ir/search?q={}',
