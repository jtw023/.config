...
vim.keymap.set('n', '<F3>', ':tabnew $HOME/.config/Linux/nvim/lua/main/keymap.lua<CR>', opts)
...
opts.desc = 'First Git Push'
vim.keymap.set('n', 't', ":<BS><BS><BS><BS><BS>Git push --set-upstream origin <C-r>*", opts)
