...
ls.add_snippets(nil, {
    ...
    python = {
        ...
        snip({
            ...
            insert(1, "docstring"),
            text({"", ":param: "}),
            insert(2, "info about parameters"),
            text({"", ":ptype: "}),
            insert(3, "info about param types"),
            text({"", ":return: "}),
            insert(4, "info about return value"),
            text({"", ":rtype: "}),
            insert(5, "info about return type"),
            text({"", ":raises error: "}),
            insert(6, "error type and when"),
            text({"", "'''"}),
            insert(7, "")
        })
    },
