...
cmp.setup {
    ...
    formatting = {
        ...
        format = function(entry, vim_item)
            ...
            -- NOTE: order matters
            vim_item.menu = ({
                ["vim-dadbod-completion"] = kind_icons.Database,
                luasnip = kind_icons.Snippet,
                nvim_lua = kind_icons.NVIM,
                nvim_lsp = kind_icons.LSP,
                path = "../..",
                calc = kind_icons.Operator,
                buffer = kind_icons.File,
                spell = kind_icons.Text,
            })[entry.source.name]
            return vim_item
        end,
    },
